...
namespace System
{
    ...
    public static class StringExtension
    {
        ...
        public static int? AsIntOrNull(this string strSource)
        {
        ...
        /// <param name="strSource">数字字符串</param>
        /// <returns>转换成功则为实际数字，转换失败则返回null</returns>
        public static long? AsLongOrNull(this string strSource)
        {
        ...
        /// <returns>转换成功则为实际数字，转换失败则返回null</returns>
        public static double? AsDoubleOrNull(this string strSource)
        {
        ...
        /// <param name="strSource"></param>
        /// <returns>转换成功则为实际数字，转换失败则返回null</returns>
        public static decimal? AsDecimalOrNull(this string strSource)
        {
        ...
        public static bool? AsBooleanOrNull(this string strSource)
        {
        ...
        /// <param name="strSource"></param>
        /// <returns>转换成功则为实际数字，转换失败则返回null</returns>
        public static float? AsFloatOrNull(this string strSource)
        {
        ...
        /// <param name="strSource"></param>
        /// <returns>转换成功则为实际数字，转换失败则返回null</returns>
        public static DateTime? AsDateTimeOrNull(this string strSource)
        {
        ...
        public static int AsIntOrDefault(this string strSource, int defaultValue = default(int))
        {
        ...
        public static long AsLongOrDefault(this string strSource, long defaultValue = default(long))
        {
            if (long.TryParse(strSource, out long result))
                return result;
            else
        ...
        /// <param name="defaultValue">默认值</param>
        /// <returns>转换成功则为实际数字，转换失败则为默认值</returns>
        public static double AsDoubleOrDefault(this string strSource, double defaultValue = default(double))
        {
            if (double.TryParse(strSource, out double result))
                return result;
            else
        ...
        /// <param name="defaultValue">默认值</param>
        /// <returns>转换成功则为实际数字，转换失败则为默认值</returns>
        public static decimal AsDecimalOrDefault(this string strSource, decimal defaultValue = default(decimal))
        {
            if (decimal.TryParse(strSource, out decimal result))
                return result;
            else
        ...
        /// <returns>转换成功则为实际数字，转换失败则为默认值</returns>
        public static bool AsBooleanOrDefault(this string strSource, bool defaultValue = default(bool))
        {
            if (bool.TryParse(strSource, out bool result))
                return result;
            else
        ...
        /// <param name="defaultValue">转换失败时，返回的值</param>
        /// <returns>转换成功则为实际数字，转换失败则为默认值</returns>
        public static float AsFloatOrDefault(this string strSource, float defaultValue = default(float))
        {
            if (float.TryParse(strSource, out float result))
                return result;
            else
        ...
        public static DateTime AsDateTimeOrDefault(this string strDateTime, DateTime defaultDate = default(DateTime))
        {
